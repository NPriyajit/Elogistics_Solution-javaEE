...
<body>
    ...
    %>
      ...
      <h3   style="text-align:center;padding-bottom:15px;">Issue Of Goods &nbsp;<sup><small class="text-muted">Report</small></sup></h3>
    <div class="well" style="border-top: solid black;border-bottom: solid black ;" >
      ...
      <table  style="margin-top:40px; border:2px solid black; font-size:12px;"class="table ">
        ...
        try{
            ...
            rsshow=stmtfill.executeQuery("select * from tblissuegoodsinfo");
            i=0;
            sl=0;
            while(rsshow.next())
            {
