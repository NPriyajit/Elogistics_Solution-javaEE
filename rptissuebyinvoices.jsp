...
<body>
    ...
    ResultSet rsfill,rsshow;
      ...
      String  disper , disamt , cgst , sgst , taxamt , netamt ,sinvno;
    int i,sl;
...
%>
      ...
      <h3   style="text-align:center;padding-bottom:15px;">Issue Of Goods [<%=sinvno %>] &nbsp;<sup><small class="text-muted">Report</small></sup></h3>
