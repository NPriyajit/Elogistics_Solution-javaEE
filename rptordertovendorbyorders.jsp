...
<body>
    ...
    String  ordno, datedet, vendname,locality,city,state,slno,prodcode,prodname,prodcat,price,quant,amt,sorderno;
    int i,sl;
...
<% 
sorderno=request.getParameter("cmbordno");
%>


      <h3   style="text-align:center;padding-bottom:15px;">Order Information [<%=sorderno %>] &nbsp;<sup><small class="text-muted">Report</small></sup></h3>
    ...
    <div class="well" style="border-top: solid black;border-bottom: solid black ;" >
      ...
      <table  style="margin-top:40px; border:2px solid black; font-size:12px;"class="table ">
        ...
        try{
            ...
            rsshow=stmtfill.executeQuery("select * from tblorderinfo where orderno='"+sorderno+"'");
            i=0;
            sl=0;
            while(rsshow.next())
            {
