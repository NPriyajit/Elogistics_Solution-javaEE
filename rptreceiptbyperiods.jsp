...
<body>
    ...
    String  vouchno, vdate, retname,locality,city,state,bankname,refno,recmode,refdate,amt,sfrom,sto;
    int i,sl;
...
%>
      ...
      <h3   style="text-align:center;padding-bottom:15px;">Receipt Information [<%= sfrom %> - <%= sto %>] &nbsp;<sup><small class="text-muted">Report</small></sup></h3>
    ...
    <div class="well" style="border-top: solid black;border-bottom: solid black ;" >
      ...
      <table  style="margin-top:40px; border:2px solid black; font-size:12px;"class="table ">
        ...
        try{
            ...
            rsshow=stmtfill.executeQuery("select * from tblreceiptinfo where vdate>='"+sfrom+"' and vdate <= '"+sto+"'");
            i=0;
            sl=0;
            while(rsshow.next())
            {
