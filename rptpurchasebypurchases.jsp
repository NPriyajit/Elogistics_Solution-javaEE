...
<html>
<title>Report Purchase Information</title>
...
<body>
    ...
    ResultSet rsfill,rsshow;
      String  orderno , odate , vendname , locality , city , state , slno , prodcode , prodname , prodcat , price , quant , amt , pdate ,purchno;
      String  disper , disamt , cgst , sgst , taxamt , netamt,spurchno ;
    int i,sl;
...
<%
spurchno=request.getParameter("cmbpurchno");
%>

      <h3   style="text-align:center;padding-bottom:15px;">Purchase Information [<%=spurchno%>] &nbsp;<sup><small class="text-muted">Report</small></sup></h3>
    <div class="well" style="border-top: solid black;border-bottom: solid black ;" >
      ...
      <table  style="margin-top:40px; border:2px solid black; font-size:12px;"class="table ">
        ...
        try{
            ...
            rsshow=stmtfill.executeQuery("select * from tblpurchaseinfo where purchaseno='"+spurchno+"'");
            i=0;
            sl=0;
            while(rsshow.next())
            {
              purchno=rsshow.getString("purchaseno");
            pdate = rsshow.getString("pdate");
