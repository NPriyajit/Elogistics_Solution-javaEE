...
<%
    sprodname=request.getParameter("cmbprodname");
    %>


      <h3   style="text-align:center;padding-bottom:15px;">Product Information [<%= sprodname %>] &nbsp;<sup><small class="text-muted">Report</small></sup></h3>
