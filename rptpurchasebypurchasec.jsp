...
<h3   style="text-align:center;padding-bottom:15px;">Purchase Information [Any] &nbsp;<sup><small class="text-muted">Report</small></sup></h3>
  ...
  <div class="well" style="border-top: solid black;border-bottom: solid black ;" >
          <div class="container">
                  ...
                  <form name="f1" id="myForm" action="rptpurchasebypurchases.jsp" >
                        <table class="table table-borderless ">
                            ...
                            Purchase No:
                                 ...
                                 <td>
                          <div class="col-xs-4" >
                                    <select name="cmbpurchno"  id="inputs" class="form-control input-sm" >
                       ...
                       <%
                           ...
                           while(rsfill.next()){
                             ...
                             %>
                             <option value="<%=purchno%>"><%=purchno %></option>
                             <%
                           }
                         }
