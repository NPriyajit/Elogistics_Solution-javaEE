...
<h3   style="text-align:center;padding-bottom:15px;">Receipt Information [Any] &nbsp;<sup><small class="text-muted">Report</small></sup></h3>
  ...
  <div class="well" style="border-top: solid black;border-bottom: solid black ;" >
          <div class="container">
                  ...
                  <form name="f1" id="myForm" action="rptreceiptbynames.jsp" >
                       <table class="table table-borderless ">
                            ...
                            Retailer Name:
                                 ...
                                 <td>
                          <div class="col-xs-4" >
                                    <select name="cmbretname"  id="inputs" class="form-control input-sm" >
                                        <option value="">-Select-</option>
                       <%
                           doConnect();
                           try{
                           stmtfill=conn.createStatement();
                           rsfill=stmtfill.executeQuery("select * from tblreceiptinfo");
                           while(rsfill.next()){
