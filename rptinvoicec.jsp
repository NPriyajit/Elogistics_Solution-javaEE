...
<h3   style="text-align:center;padding-bottom:15px;">Invoice Information [Any] &nbsp;<sup><small class="text-muted">Report</small></sup></h3>

  
  <div class="well" style="border-top: solid black;border-bottom: solid black ;" >
          <div class="container">

                  <form name="f1" id="myForm" action="rptinvoices.jsp" >
                       <table class="table table-borderless ">
                            ...
                            Invoice No:
                                 ...
                                 <td>
                          <div class="col-xs-4" >
                                    <select name="cmbinvno" align="left" id="inputs" class="form-control input-sm" >
